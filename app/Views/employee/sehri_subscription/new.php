...
<?= form_open('employee/sehri-subscription/store') ?>
  <?= csrf_field() ?>
...
<!-- Make sure the shared JS that defines initMealCalendar is loaded before this -->
<script>
document.addEventListener('DOMContentLoaded', () => {
  initMealCalendar({
    // Ramadan window for Sehri (clamps the picker)
