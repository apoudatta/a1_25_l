...
$shortcutMenus = [
  ['icon' => 'bi-clipboard-check', 'text' => 'Lunch Subscription', 'url' => site_url('subscription/new')],
  ['icon' => 'bi-person-x', 'text' => 'Subscription List', 'url' => site_url('subscription/all-subscriptions')],
  ['icon' => 'bi-brightness-high', 'text' => 'Ifter Subscription', 'url' => site_url('ifter-subscription/all-ifter-list')],
  ['icon' => 'bi-building', 'text' => 'Seheri Subscription', 'url' => site_url('ramadan/sehri-subscription/all-sehri-list')],
  ['icon' => 'bi-moon-stars', 'text' => 'Eid Meal', 'url' => site_url('eid-subscription/all-eid-subscription-list')],
  ['icon' => 'bi-megaphone', 'text' => 'Intern Subscription', 'url' => site_url('intern-requisitions')],
];
?>
